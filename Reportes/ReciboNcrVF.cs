...
namespace ICG_Inter.Reportes {
    ...
    public class ReciboNcrVF : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ICG_Inter.Reportes.ReciboNcrVF.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReciboNcrVF : Component, ICachedReport {
        
        public CachedReciboNcrVF() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReciboNcrVF rpt = new ReciboNcrVF();
            rpt.Site = this.Site;
            return rpt;
        }
